...
<form action="<?php echo e(route('todos')); ?>" method="POST"> <!--Envio a la ruta name-->
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Practicas\PHP\tareas_laravel\resources\views/todos/index.blade.php ENDPATH**/ ?>